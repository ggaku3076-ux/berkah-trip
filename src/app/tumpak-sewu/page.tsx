...
const galeriFoto = [
  { src: "/Asset/f37558505720ad55e12fd4c52b1e3f8e.jpg", alt: "Panorama Keindahan Air Terjun Tumpak Sewu", caption: "Tumpak Sewu Panorama", location: "Lumajang, Jawa Timur" },
  { src: "/Asset/3bea83de12769c0b2f70cf4656aa7998.jpg", alt: "Tebing Megah Air Terjun Tumpak Sewu", caption: "Tebing Air Terjun", location: "Lumajang, Jawa Timur" },
  { src: "/Asset/IMG-20260715-WA0017.jpg", alt: "Aliran Air dan Petualangan di Tumpak Sewu", caption: "Petualangan Bawah Tebing", location: "Lumajang, Jawa Timur" },
  { src: "/Asset/IMG-20260715-WA0018.jpg", alt: "Trekking Goa Tetes Tumpak Sewu", caption: "Eksplorasi Goa Tetes", location: "Lumajang, Jawa Timur" },
];
...
export default function TumpakSewuPage() {
  return (
    <section className="bg-[var(--canvas)] pt-28 md:pt-36 pb-20" aria-labelledby="tumpak-sewu-title">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        ...
        <Reveal>
          <div className="max-w-xl mb-12">
            ...
            <h1 id="tumpak-sewu-title" className="display-lg text-[var(--ink)] font-sans mt-3">
              Mediasi Trip Tumpak Sewu
            </h1>
            <p className="text-[var(--ink-muted)] text-xs mt-2 font-light leading-relaxed max-w-sm">
              Foto dokumentasi riil perjalanan bersama kami ke Tumpak Sewu. Bukan stok foto, ini nyata.
            </p>
          </div>
        </Reveal>
        ...
        <Reveal delay={100} className="mt-12">
          <div className="bg-gradient-to-r from-[#1e3a8a] to-[#1d4ed8] rounded-2xl p-6 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-white text-center md:text-left">
              <h2 className="text-xl font-light">Siap Berangkat ke Tumpak Sewu?</h2>
