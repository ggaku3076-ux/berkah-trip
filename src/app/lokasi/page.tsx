      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-base text-brand-dark/70 mt-4 font-light">
            Kami siap melayani kebutuhan private trip Bromo Anda 24 jam nonstop. Hubungi kami melalui kontak di bawah ini.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mt-8">
            ...
            <div>
              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-brand-dark text-sm">Lokasi Penjemputan</h3>
                    <p className="text-sm text-brand-dark/70 mt-1 leading-relaxed font-light">
                      Surabaya & Sidoarjo (Hotel, Bandara, Stasiun, Rumah)
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-brand-dark/70 mt-1">
                      <a href="tel:+6283116788444" className="hover:text-brand-orange transition-colors">
                        083116788444
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-brand-dark text-sm">Layanan</h3>
                    <p className="text-sm text-brand-dark/70 mt-1">
                      Private Trip Bromo & Sewa Mobil Surabaya
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-6 p-6 sm:p-8 bg-white border border-slate-200 rounded-2xl">
            <h2 className="text-xl font-bold text-brand-dark text-left font-nunito">Area Operasional</h2>
            ...
            <div className="relative aspect-[16/10] w-full rounded-xl border border-slate-200 bg-slate-50 p-4 flex flex-col justify-between overflow-hidden">
              ...
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1 z-10">
                ...
                <span className="bg-brand-dark text-white text-[10px] font-bold px-2 py-0.5 rounded shadow">Surabaya & Bromo</span>
              </div>
            </div>

            <div className="flex flex-col gap-4 text-left">
              <p className="text-xs text-brand-dark/60 leading-relaxed font-light">
                Konsultasikan jadwal penjemputan Anda sekarang secara gratis via WhatsApp. Layanan private trip tidak digabung rombongan lain.
              </p>
